/***************************************************************************
 tag: Sava Marinkov  Thu May 12 12:50:00 CET 2011  PanTiltController.hpp
...
#ifndef PANTILTCONTROLLER_HPP
#define PANTILTCONTROLLER_HPP
...
class PanTiltController : public RTT::TaskContext {
	private:
	...
	public:
		PanTiltController(const std::string& name);
		~PanTiltController(){};
