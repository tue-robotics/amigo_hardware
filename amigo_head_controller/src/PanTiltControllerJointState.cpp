...
#include "PanTiltControllerJointState.hpp"
...
PanTiltControllerJointState::PanTiltControllerJointState(const std::string& name) :
...
bool PanTiltControllerJointState::configureHook() {
	state = 1;
...
bool PanTiltControllerJointState::startHook() {
...
void PanTiltControllerJointState::dxl_tx_rx_packet(void) {
	dxl_tx_packet();
...
void PanTiltControllerJointState::dxl_tx_packet(void)
{
...
void PanTiltControllerJointState::dxl_rx_packet(void) {
...
void PanTiltControllerJointState::dxl_set_txpacket_id( int id )
{
	gbInstructionPacket[ID] = (unsigned char)id;
}

void PanTiltControllerJointState::dxl_set_txpacket_instruction( int instruction )
{
	gbInstructionPacket[INSTRUCTION] = (unsigned char)instruction;
}

void PanTiltControllerJointState::dxl_set_txpacket_parameter( int index, int value )
{
	gbInstructionPacket[PARAMETER+index] = (unsigned char)value;
}

void PanTiltControllerJointState::dxl_set_txpacket_length( int length )
{
	gbInstructionPacket[LENGTH] = (unsigned char)length;
}

int PanTiltControllerJointState::dxl_get_rxpacket_id(void) {
...
int PanTiltControllerJointState::dxl_get_rxpacket_length(void)
{
	return (int)gbStatusPacket[LENGTH];
}

bool PanTiltControllerJointState::dxl_check_rxpacket_checksum(void)
{
	unsigned char checksum = 0;
...
int PanTiltControllerJointState::dxl_get_rxpacket_parameter( int index )
{
	return (int)gbStatusPacket[PARAMETER+index];
}

int PanTiltControllerJointState::dxl_makeword( int lowbyte, int highbyte )
{
	unsigned short word;
...
int PanTiltControllerJointState::dxl_get_lowbyte( int word )
{
	unsigned short temp;
...
int PanTiltControllerJointState::dxl_get_highbyte( int word )
{
	unsigned short temp;
...
void PanTiltControllerJointState::dxl_ping( int id )
{
	gbInstructionPacket[ID] = (unsigned char)id;
...
void PanTiltControllerJointState::dxl_read_byte( int id, int address )
{
	gbInstructionPacket[ID] = (unsigned char)id;
...
void PanTiltControllerJointState::dxl_write_byte( int id, int address, int value )
{
	gbInstructionPacket[ID] = (unsigned char)id;
...
void PanTiltControllerJointState::dxl_read_word( int id, int address )
{
	gbInstructionPacket[ID] = (unsigned char)id;
	gbInstructionPacket[INSTRUCTION] = INST_READ;
	gbInstructionPacket[PARAMETER] = (unsigned char)address;
...
void PanTiltControllerJointState::dxl_write_word( int id, int address, int value )
{
	gbInstructionPacket[ID] = (unsigned char)id;
	gbInstructionPacket[INSTRUCTION] = INST_WRITE;
	gbInstructionPacket[PARAMETER] = (unsigned char)address;
