...
bool ReadArmJointsMsg2::startHook()
{
  ...
  jointdataref1[3] = 0.00;
  jointdataref1[4] = 0.00;
    
  jointdataref2[0] =  0.0;
  jointdataref2[1] = -0.10; 
  jointdataref2[2] = -0.00; 
  jointdataref2[3] = -0.00;
  jointdataref2[4] = -0.00;  
  counter = 0;
...
{ 
  ...
  if (goodtogo && enable)
  {
	  ...
	  jointdata.pos[0].data = jointdataref2[counter];
