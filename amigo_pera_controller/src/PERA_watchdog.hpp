...
namespace PERA
{
  ...
  : public RTT::TaskContext
    ...
    private:
		...
		//! Outputport streaming PERA status to a rostopic
		OutputPort<amigo_msgs::pera_status> peraStatusPort;
    ...
    public:
		...
		//! Function for updating the PERA status
		amigo_msgs::pera_status updateStatus(doubles jointErrors);
